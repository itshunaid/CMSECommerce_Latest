...
- [x] Integrate audit logging into all relevant controllers/actions (user management, product approvals, order processing, etc.)
...
- Integration across all admin controllers for complete coverage
